...
# Analisa a planilha para o dia 24/11
...
# Encontra o índice do dia 24/11
dia_24_idx = None
...
if dia_24_idx is None:
    print("❌ Dia 24/11/2025 não encontrado na planilha")
    exit(1)

print("="*100)
print(f"📅 ANÁLISE DO DIA 24/11/2025 (índice {dia_24_idx})")
print("="*100)

# Extrai todos os lançamentos do dia 24/11 da planilha
...
for idx, linha in enumerate(linhas_dados):
    ...
    col_valor = dia_24_idx * 2
    col_modalidade = dia_24_idx * 2 + 1
    ...
    if valor and modalidade:
        ...
        for mod in modalidades:
            ...
            if eh_crediario and "Recebimento" not in mod:
                print(f"⏭️  IGNORANDO (Crediário): R$ {valor_por_modalidade:,.2f} - {mod}")
...
print(f"\n📋 LANÇAMENTOS NA PLANILHA (dia 24/11) - NÃO CREDIÁRIO:")
